...
public class UserController {
	...
	@GetMapping("/login")
	public String loginPageLoader(@ModelAttribute("loginUserInfo") UserDTO userbean,
	...
	public String loginProcedure(@Valid @ModelAttribute("loginUserInfo") UserDTO loginUserInfo,
								 @RequestParam(value="fail", defaultValue="false") boolean fail,
		...
		// 로그인 성공한 경우 처리하는 부분
		UserDTO ifSuccess = userService.checkExistUser(loginUserInfo);
	...
	@GetMapping("/join")
	public String joinPageLoader(@ModelAttribute("joinUserBean") UserDTO joinUserBean,
	        					Model model) {
	...
	public String joinProcedure(@ModelAttribute("joinUserBean") UserDTO joinUserBean,
	...
	@GetMapping("/modify")
	public String updatePageLoader(@ModelAttribute("loggedUserInfo") UserDTO loggedUserInfo,
	...
	public String updateProcedure(@ModelAttribute("loggedUserInfo") UserDTO loggedUserInfo,
