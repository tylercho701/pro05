...
public class QnaService {
	...
	public void addContentInfo(QnaBean writeQnaBean) {
...
//		noticeDAO.addContentInfo(writeNoticeBean);
...
//		3	->	20
	...
	// 상세페이지에 출력할 데이터 가져오기
	public QnaBean getQnaDetail(String qna_idx) {
		
		return qnaDAO.getQnaInfo(qna_idx);
	}
